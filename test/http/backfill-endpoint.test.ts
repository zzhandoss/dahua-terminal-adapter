...
describe("POST /events/backfill", () => {
  it("returns 401 when bearer token is missing", async () => {
    ...
    const app = buildServer(env, runtime as unknown as AdapterRuntime);
...
function makeRuntimeStub(events: NormalizedEvent[]): {
  calls: Array<{ deviceId: string; sinceEventId: string | null; limit: number }>;
